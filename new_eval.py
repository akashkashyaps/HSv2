...
def initialize_metrics():
   context_precision = PromptTemplate( input_variables=["user_input", "reference", "retrieved_contexts"], template=""" You are a helpful assistant tasked with evaluating the performance of a Retrieval-Augmented Generation (RAG) system. Your job is to compute the Context Precision metric based on the inputs provided below. Inputs:
   ...
   context_recall = PromptTemplate( input_variables=["user_input", "reference", "retrieved_contexts"], template=""" You are a helpful assistant tasked with evaluating the performance of a Retrieval-Augmented Generation (RAG) system. Your job is to compute the Context Recall metric based on the inputs provided below. Inputs:
