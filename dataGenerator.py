...
# Function to generate and save test sets in chunks
def generate_and_save_testsets(splits, total_samples, filename_prefix, chunk_size=1):
    remaining_samples = total_samples
    test_dfs = []
...
generate_and_save_testsets(recreated_splits, total_samples=5, filename_prefix='testset6', chunk_size=1)