...
quantitative_result_phi = evaluate_ragas_dataset(dataset)
# qualitative_result_qwen = qualitative_analysis(dataset)
quantitative_result_phi.to_pandas().to_csv("Base_Mistral7B-Evaluator_Phi3-quantitative.csv", index=False)
